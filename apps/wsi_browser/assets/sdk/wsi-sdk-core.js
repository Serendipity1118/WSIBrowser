/* WSI SDK 2.0.0 (inappwebview adapter). Generated from packages/wsi_sdk - do not edit by hand. */
(() => {
  // src/core/button.js
  var MIN_TAP = 44;
  var EDGE = 20;
  ...
  // src/adapters/inappwebview.js
  var HANDLER = "wsi";
  var READY_EVENT = "flutterInAppWebViewPlatformReady";
  ...
  function createInAppWebViewAdapter({ token }) {
    const call = async (op, payload) => {
      await whenReady();
      try {
        const result = await window.flutter_inappwebview.callHandler(HANDLER, { token, op, payload: payload != null ? payload : {} });
        return result;
      } catch (e) {
